...
static const gicv2_driver_data_t rpi5_gic_data = {
	.gicd_base = RPI5_GIC_GICD_BASE,
	.gicc_base = RPI5_GIC_GICC_BASE,
};
...
static uintptr_t rpi5_get_dtb_address(void)
{
...

{
	 ...
	 * must be 0.
	 */
	VERBOSE("rpi5: Preparing to boot 64-bit Linux kernel\n");
	bl33_image_ep_info.args.arg0 = rpi5_get_dtb_address();
	bl33_image_ep_info.args.arg1 = 0ULL;
	bl33_image_ep_info.args.arg2 = 0ULL;
	bl33_image_ep_info.args.arg3 = 0ULL;
#endif /* RPI5_DIRECT_LINUX_BOOT */
}
...
void bl31_plat_arch_setup(void)
{
	...
	rpi5_setup_page_tables(BL31_BASE, BL31_END - BL31_BASE,
...
static void rpi5_prepare_dtb(void)
{
	void *dtb = (void *)rpi5_get_dtb_address();
