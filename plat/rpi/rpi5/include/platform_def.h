 ...
 */
#define PLAT_PHY_ADDR_SPACE_SIZE	(ULL(1) << 38)
#define PLAT_VIRT_ADDR_SPACE_SIZE	(ULL(1) << 38)
 ...
 */
#define PLAT_RPI_PL011_UART_BASE	RPI5_PL011_UART_BASE
#define PLAT_RPI_PL011_UART_CLOCK       RPI5_PL011_UART_CLOCK
